...
<section id="t-biography">
	<header class="content-header">
		...
		<blockquote class="by-author">
			...
			<p><strong>Flávio Tavares</strong></p>
		</blockquote>
		<footer>
			...
			<ol>
				<li>
					<figure data-index="1" class="img-1">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/media/img/img-biography-work-1.jpg" height="188" width="274">
					</figure>
					<dl>
				...
				<li>
					<figure data-index="2" class="img-2">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/media/img/img-biography-work-2.jpg" height="188" width="264">
					</figure>
					<dl>
				...
				<li>
					<figure data-index="3" class="img-3">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/media/img/img-biography-work-3.jpg" height="188" width="375">
					</figure>
					<dl>
						<dd class="title">Sem título</dd>
				...
				<li>
					<figure data-index="4" class="img-4">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/media/img/img-biography-work-4.jpg" height="244" width="155">
					</figure>
					<dl>
						<dd class="title">Sem título</dd>
						<dd class="specs">Pastel 83 x 93 cm</dd>
