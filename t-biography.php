...
<section id="t-biography">
	...
	<aside class="extras">
		...
		<section class="curriculum">
			...
			<p class="curriculum-desc"><?php printf(__('Baixe um PDF (21MB) com o currículo do artista <a href="%s">clicando aqui</a>.', 'flaviotavares'), home_url('/wp-content/uploads/2013/04/curriculo-flavio-tavares.pdf')); ?></p>
		</section>
